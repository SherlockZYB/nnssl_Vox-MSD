...
from nnssl.training.nnsslTrainer.PCLRv2.PCLRv2_Trainer import PCRLv2Trainer
...
def maybe_load_checkpoint(
    ...
    if continue_training:
        ...
        if pretrained_weights_file is not None:
            ...
            if isinstance(nnunet_trainer, PCRLv2Trainer):
                load_pretrained_weights(nnunet_trainer.network.network, pretrained_weights_file, verbose=True)
            else:
