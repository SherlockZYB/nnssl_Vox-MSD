...
def load_pretrained_weights(network, fname, verbose=False):
    ...
    skip_strings_in_pretrained = [
        ...
        # '.seg_layer.',
        # 'projector.',
        # 'decoder.',   # 由于PCLR不用skipconnection，所以只加载encoder的预训练权重来辅助再次预训练
        'up_projection',   # transformer中up_projection的参数也非必要
        # 'down_projection',  
        # 'mask_token',
        # 'eva'
    ]
    ...
    # 为了加载simclr的权重用的
    # pretrained_dict = {k[len("encoder."):]: v for k, v in pretrained_dict.items()}
